"""
Django settings for datinghub_project project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'dating-hub.com.au', 'www.dating-hub.com.au']
...
# Use DATABASE_URL environment variable (set by Render for PostgreSQL)
