...
SECRET_KEY = 'datinghub-final-2025'
...
ADMIN_EMAIL = 'info@dating-hub.com.au'

# CSRF settings (important for forms)
CSRF_TRUSTED_ORIGINS = ['http://localhost:8000', 'http://127.0.0.1:8000']

# Session settings (for form data)
